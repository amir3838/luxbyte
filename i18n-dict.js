...
const i18nDict = {
  ar: {
    // Brand
    "brand.luxbyte":"LUXBYTE","brand.luxbyte_llc":"شركة لوكس بايت المحدودة المسئولية","brand.shop_eg":"شوب إي جي","brand.master_driver":"ماستر درايفر",
    ...
    // Features Block
    "home.features_block.title":"لماذا LUXBYTE؟","home.features_block.security_title":"أمان وموثوقية","home.features_block.security_desc":"نستخدم أحدث تقنيات الأمان لحماية بياناتك ومعاملاتك المالية","home.features_block.ease_title":"سهولة الاستخدام","home.features_block.ease_desc":"واجهة بسيطة وسهلة الاستخدام تعمل على جميع الأجهزة","home.features_block.support_title":"دعم فني متميز","home.features_block.support_desc":"فريق دعم فني متخصص متاح على مدار الساعة لمساعدتك","home.features_block.reports_title":"تقارير مفصلة","home.features_block.reports_desc":"احصل على تقارير مفصلة عن أداء عملك واتخاذ قرارات مدروسة",

    // CTA Block
    "home.cta_block.title":"جاهز للبدء؟","home.cta_block.desc":"انضم إلى آلاف العملاء الذين يثقون في LUXBYTE لتطوير أعمالهم","home.cta_block.start_now":"ابدأ الآن","home.cta_block.contact_us":"تواصل معنا",
    ...
    // Footer
    "home.footer.copyright":"© 2024 LUXBYTE LLC. جميع الحقوق محفوظة.","home.footer.company_line":"شركة لوكس بايت المحدودة المسئولية - مصر",

    // Choose Platform
    "choose_platform.title":"اختيار المنصة - LUXBYTE","choose_platform.heading":"اختر منصة LUXBYTE المناسبة لك","choose_platform.subheading":"اختر منصتك","choose_platform.helper":"اختر المنصة المناسبة لاحتياجاتك",
    ...
    // Auth
    "auth.title":"تسجيل الدخول - LUXBYTE","auth.subtitle":"تسجيل الدخول أو إنشاء حساب جديد في LUXBYTE","auth.welcome":"مرحباً بك في LUXBYTE","auth.email":"البريد الإلكتروني","auth.password":"كلمة المرور","auth.password_ph":"أدخل كلمة المرور","auth.remember_me":"تذكرني","auth.sign_in":"تسجيل الدخول","auth.no_account":"ليس لديك حساب؟","auth.create_account":"إنشاء حساب جديد",
    "auth.signup_title":"تسجيل البيانات - LUXBYTE","auth.signup_subtitle":"تسجيل البيانات والمستندات المطلوبة","auth.join_today":"انضم إلى LUXBYTE اليوم","auth.confirm_password":"تأكيد كلمة المرور","auth.confirm_password_ph":"أكد كلمة المرور","auth.agree_terms":"أوافق على الشروط والأحكام","auth.have_account":"لديك حساب بالفعل؟","auth.signin":"تسجيل الدخول",
